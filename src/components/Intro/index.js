    ...
    return (
        <div className=' px-10 lg:px-[10rem] py-20  w-full  bg-slate-100'>
            <div className='bg-white flex justify-between rounded-2xl shadow-2xl border border-gray-200 lg:flex-row flex-col'  >
                <animated.div onMouseLeave={() => setContainerHovered(false)} onMouseEnter={() => setContainerHovered(true)} style={containerAnimation} className='m-3 border-r border-gray-200 flex flex-col justify-center items-center p-5'>
                    <animated.div style={svgAnimation} className='w-[5rem] mb-4'>
                        <PiggyBank />
                    </animated.div>
                ...
                <animated.div style={containerAnimation} className='m-3 border-r border-gray-200 flex flex-col justify-center items-center p-5'>
                    <animated.div style={svgAnimation} className='w-[5rem] mb-4'>
                        <Encrypt />
                    </animated.div>
                ...
                <animated.div style={containerAnimation} className='m-3 flex flex-col justify-center items-center p-5'>
                    <animated.div style={svgAnimation} className='w-[5rem] mb-4'>
                        <Secure />
                    </animated.div>
