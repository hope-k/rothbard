            ...
            <div className='pt-20 flex justify-center px-8 md:px-24 lg:px-7 relative '>
                <div className=' bg-[rgba(217,224,230,0.88)] z-10 lg:p-12 flex flex-col rounded-2xl relative lg:w-[40%] w-full '>
                    ...
                    <form className='flex flex-col mx-6 pb-28' onSubmit={submitHandler}>
                        ...
                        <button disabled={loading && true} type='submit' className='bg-[#1c2c5e] duration-200 text-[white] p-4 h-full w-full  rounded-lg mb-4 disabled:bg-[#1c2d5e8e] flex justify-center items-center relative'>
                            {
                                loading ? 
                                <div className='p-4 relative bottom-2'>
                                        <FadeLoader
                                        width={1}
                                        height={4}
                                        margin={-7}
